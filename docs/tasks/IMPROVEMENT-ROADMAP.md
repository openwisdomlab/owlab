...
> 部分项目已在 2026-04 的「C004 文档系统全量研究化迭代」中完成，详见 COMPLETED.md。
...
| 项目 | 来源 | 完成情况 |
|------|------|---------|
| 引用基础设施（Cite/References + 结构化书目） | 维度 4 内容体系 | ✅ 13 模块 refs.json + 124 条引用聚合管线 + Cite/References 组件 |
| 9 模块 index.mdx 内容堆积（40-110KB） | 维度 4 内容体系 | ✅ 全部压回四块脚手架，正文 ≤6000 字 |
| 模块去重映射 | 维度 4 内容体系 | ✅ L01↔M03 / L02↔M05 / L03↔M07 / L04↔M05+M06 互链 |
| Core/Extend 边界规则失守 | 维度 4 内容体系 | ✅ CLAUDE.md 重写为 ≤6000 字 + 四块强制脚手架 |
| 2024-2026 前沿研究覆盖 | 维度 4 内容体系 | ✅ 51 篇高分位（E2/E3）2024-2026 来源已落地 |
