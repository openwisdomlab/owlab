...
const modules: Module[] = [
  {
    id: "M01",
    icon: Lightbulb,
    path: "/docs/knowledge-base/01-foundations",
    status: "in_progress",
  ...
  },
  {
    id: "M02",
    icon: Network,
    path: "/docs/knowledge-base/02-governance",
    status: "in_progress",
  ...
  },
  {
    id: "M03",
    icon: Building2,
    path: "/docs/knowledge-base/03-space",
    status: "in_progress",
    color: "var(--neon-cyan)",
    subModules: [
  ...
  },
  {
    id: "M04",
    icon: BookOpen,
    path: "/docs/knowledge-base/04-programs",
    status: "in_progress",
  ...
  },
  {
    id: "M05",
    icon: Wrench,
    path: "/docs/knowledge-base/05-tools",
    status: "in_progress",
  ...
  },
  {
    id: "M06",
    icon: ShieldCheck,
    path: "/docs/knowledge-base/06-safety",
    status: "in_progress",
    color: "var(--neon-red)",
    subModules: [
  ...
  },
  {
    id: "M07",
    icon: Users,
    path: "/docs/knowledge-base/07-people",
    status: "in_progress",
    color: "var(--neon-pink)",
    subModules: [
  ...
  },
  {
    id: "M08",
    icon: ClipboardList,
    path: "/docs/knowledge-base/08-operations",
    status: "in_progress",
    color: "var(--neon-blue)",
    subModules: [
  ...
  },
  {
    id: "M09",
    icon: BarChart3,
    path: "/docs/knowledge-base/09-assessment",
    status: "in_progress",
    color: "var(--neon-teal)",
    subModules: [
