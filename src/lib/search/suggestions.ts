...
export const moduleQuickLinks: Record<string, { title: string; path: string }[]> = {
  zh: [
    { title: "M01 理念与理论", path: "/zh/docs/core/01-foundations" },
    { title: "M02 治理与网络", path: "/zh/docs/core/02-governance" },
    { title: "M03 空间与环境", path: "/zh/docs/core/03-space" },
    { title: "M04 课程与项目", path: "/zh/docs/core/04-curriculum" },
    { title: "M05 工具与资产", path: "/zh/docs/core/05-tools" },
  ...
  en: [
    ...
    { title: "M02 Governance & Network", path: "/en/docs/core/02-governance" },
    { title: "M03 Space & Environment", path: "/en/docs/core/03-space" },
    { title: "M04 Courses & Projects", path: "/en/docs/core/04-curriculum" },
    { title: "M05 Tools & Assets", path: "/en/docs/core/05-tools" },
